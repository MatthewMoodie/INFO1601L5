...
if ("false") console.log("Hello false!"); // but "false" is true enough here
...
for (let i = 0; i < 50; i++) {
  if (i % 3 === 0 && i % 5 === 0) {
    ...
    // ok it's not divisible by both how about just 3?
    console.log("fizz");
  } else if (i % 5 === 0) {
    // no? what about just 5 then?
    console.log("buzz");
  } else {
    // so its not divisible by 3 or 5 then
    console.log(i);
  }
}
...
console.log(arr2.join("-")); // "344-103-42-33-16--5" joins array with provided separator
...
// Filter takes a test condition and returns only the elements which
...
// Create a constructor function which builds objects for us
